...
void move_arm_automatically_right(uint8_t sn_large_motor_1, uint8_t sn_large_motor_2, uint8_t sn_medium_motor, uint8_t sn_color_sensor, uint8_t sn_touch_sensor)
{
	for(int i = 0; i < 9; i++)
	{move_arm_up(sn_large_motor_1, sn_color_sensor); usleep(200000);}

	for(int i = 0; i < 5; i++)
	{open_grapple(sn_medium_motor); usleep(200000);}

	for(int i = 0; i < 2; i++)
	{move_arm_left(sn_large_motor_2); usleep(200000);}

	for(int i = 0; i < 9; i++)
	{move_arm_down(sn_large_motor_1, sn_color_sensor); usleep(200000);}

	for(int i = 0; i < 5; i++)
	{close_grapple(sn_medium_motor); usleep(200000);}
...
void move_arm_automatically_left(uint8_t sn_large_motor_1, uint8_t sn_large_motor_2, uint8_t sn_medium_motor, uint8_t sn_color_sensor, uint8_t sn_touch_sensor)
{
	for(int i = 0; i < 9; i++)
	{move_arm_up(sn_large_motor_1, sn_color_sensor); usleep(200000);}
	...
	for(int i = 0; i < 29; i++)
	{move_arm_right(sn_large_motor_2, sn_touch_sensor); usleep(200000);}
